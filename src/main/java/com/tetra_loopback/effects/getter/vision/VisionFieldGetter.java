...
public class VisionFieldGetter implements IStatGetter {
    private final IStatGetter effectLevelGetter;

    public VisionFieldGetter() {
        this.effectLevelGetter = new StatGetterEffectLevel(ModEffectStats.visionFieldEffect);
    }

    @Override
    public boolean shouldShow(Player player, ItemStack currentStack, ItemStack previewStack) {
        return effectLevelGetter.shouldShow(player, currentStack, previewStack);
    }
