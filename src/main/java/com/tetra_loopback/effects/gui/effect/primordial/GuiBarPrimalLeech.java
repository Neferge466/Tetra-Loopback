...
public class GuiBarPrimalLeech extends GuiBar {
    private final int barLength;
    private final int fixedColor = 0xCC3300;

    public GuiBarPrimalLeech(int x, int y, int barLength, double min, double max, boolean invertedDiff) {
