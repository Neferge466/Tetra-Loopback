...
public class GuiStatBarLightningStrike extends GuiStatBar {
    public GuiStatBarLightningStrike(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarLightningStrike(0, 0, barLength, min, max, invertedDiff);
