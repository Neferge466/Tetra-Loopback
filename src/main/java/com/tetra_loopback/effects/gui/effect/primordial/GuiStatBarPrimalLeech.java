package com.tetra_loopback.effects.gui.effect.primordial;
...
public class GuiStatBarPrimalLeech extends GuiStatBar {
    public GuiStatBarPrimalLeech(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarPrimalLeech(0, 0, barLength, min, max, invertedDiff);
