...
public class GuiStatBarSupercooling extends GuiStatBar {
    public GuiStatBarSupercooling(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarSupercooling(0, 0, barLength, min, max, invertedDiff);
