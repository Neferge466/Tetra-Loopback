...
public class GuiStatBarAstralPhase extends GuiStatBar {
    public GuiStatBarAstralPhase(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarAstralPhase(0, 0, barLength, min, max, invertedDiff);
