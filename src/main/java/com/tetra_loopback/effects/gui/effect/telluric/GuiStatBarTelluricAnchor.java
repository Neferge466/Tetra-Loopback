...
public class GuiStatBarTelluricAnchor extends GuiStatBar {
    public GuiStatBarTelluricAnchor(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarTelluricAnchor(0, 0, barLength, min, max, invertedDiff);
