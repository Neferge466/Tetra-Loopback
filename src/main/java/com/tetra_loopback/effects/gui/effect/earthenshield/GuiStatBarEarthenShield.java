...
public class GuiStatBarEarthenShield extends GuiStatBar {
    public GuiStatBarEarthenShield(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarEarthenShield(0, 0, barLength, min, max, invertedDiff);
