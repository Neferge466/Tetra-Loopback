...
public class GuiBarWindstorm extends GuiBar {
    private final int barLength;
    private final int fixedColor = 0x55FF55;

    public GuiBarWindstorm(int x, int y, int barLength, double min, double max, boolean invertedDiff) {
