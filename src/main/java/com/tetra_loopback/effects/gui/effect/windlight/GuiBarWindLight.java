...
public class GuiBarWindLight extends GuiBar {
    private final int barLength;
    private final int fixedColor = 0x99d4d4;

    public GuiBarWindLight(int x, int y, int barLength, double min, double max, boolean invertedDiff) {
