...
public class GuiStatBarVitalShield extends GuiStatBar {
    public GuiStatBarVitalShield(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarVitalShield(0, 0, barLength, min, max, invertedDiff);
