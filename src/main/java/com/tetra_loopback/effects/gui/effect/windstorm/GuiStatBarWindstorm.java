package com.tetra_loopback.effects.gui.effect.windstorm;
...
public class GuiStatBarWindstorm extends GuiStatBar {
    public GuiStatBarWindstorm(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarWindstorm(0, 0, barLength, min, max, invertedDiff);
