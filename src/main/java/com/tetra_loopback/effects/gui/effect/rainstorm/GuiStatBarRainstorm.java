...
public class GuiStatBarRainstorm extends GuiStatBar {
    public GuiStatBarRainstorm(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarRainstorm(0, 0, barLength, min, max, invertedDiff);
