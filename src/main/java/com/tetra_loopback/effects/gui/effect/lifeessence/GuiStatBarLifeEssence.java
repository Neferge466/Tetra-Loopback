...
public class GuiStatBarLifeEssence extends GuiStatBar {
    public GuiStatBarLifeEssence(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarLifeEssence(0, 0, barLength, min, max, invertedDiff);
