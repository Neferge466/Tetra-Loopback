...
public class GuiStatBarVisionField extends GuiStatBar {
    public GuiStatBarVisionField(int x, int y, int barLength, String label, double min, double max,
        ...
        this.bar = new GuiBarVisionField(0, 0, barLength, min, max, invertedDiff);
